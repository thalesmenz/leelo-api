...
router.post('/', authenticateToken, asyncHandler(accountsPayableController.createAccountsPayable));
...
router.put('/:id', authenticateToken, asyncHandler(accountsPayableController.updateAccountsPayable));

// Delete accounts payable
router.delete('/:id', authenticateToken, asyncHandler(accountsPayableController.deleteAccountsPayable));

// Mark as paid
router.patch('/:id/pay', authenticateToken, asyncHandler(accountsPayableController.markAsPaid));
